...
const defaultAffairs : Array<AffairType> = [ // need to fix any
    {_id: 1, name: 'React', priority: 'middle'}, // студенты могут изменить содержимое name и количество элементов в массиве, ...priority не менять!
...
function HW2() {
    ...
    const deleteAffairCallback = (_id: number) => { // need to fix any
         setAffairs(affairs.filter(el => el._id !== _id)) // Чет хуй знает
    }
